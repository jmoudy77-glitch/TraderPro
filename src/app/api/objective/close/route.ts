// /Users/joshmoudy/dev/traderpro/src/app/api/objective/close/route.ts
...
export async function POST(req: Request) {
  ...
  if (jwt) {
    ...
    const { data, error } = await supabase.rpc("close_objective_frame", {
  ...
  const { data, error } = await supabase.rpc("close_objective_frame_for_user", {
